...
<section id="basic-datatable">
    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">About Baksa</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Baksa District Map</h4>
                </div>
                <div class="card-body">
                    <div class="leaflet-map" id="geojson-baksa"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    function GetSchoolData(schoolName, udice_code, pin) {
        ...
        // ajax: assetPath + 'data/user-list.json', // JSON file to add data
            ...
            ajax: {
                ...
                data : { 'district' : 'Baksa', 'school_name': schoolName, 'udice_code': udice_code, 'pin': pin },
                type: 'GET',
                dataSrc: ''
            },
