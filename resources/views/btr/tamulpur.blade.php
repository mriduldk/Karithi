...
@section('title', 'Tamulpur District')
...
<section id="basic-datatable">
    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">About Tamulpur</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tamulpur District Map</h4>
                </div>
                <div class="card-body">
                    <div class="leaflet-map" id="geojson-tamulpur"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    function GetSchoolData(schoolName, udice_code, pin) {
        ...
        // ajax: assetPath + 'data/user-list.json', // JSON file to add data
            ...
            ajax: {
                ...
                data : { 'district' : 'Tamulpur', 'school_name': schoolName, 'udice_code': udice_code, 'pin': pin },
                type: 'GET',
                dataSrc: ''
            },
