...
@section('title', 'Kokrajhar District')
...
<section id="basic-datatable">
    ...
    <div class="row">
        <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">About Kokrajhar</h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6 align-items-stretch">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Kokrajhar District Map</h4>
                </div>
                <div class="card-body">
    ...
    function GetSchoolData(schoolName, udice_code, pin) {
        ...
        // ajax: assetPath + 'data/user-list.json', // JSON file to add data
            ...
            ajax: {
                ...
                data : { 'district' : 'Kokrajhar', 'school_name': schoolName, 'udice_code': udice_code, 'pin': pin },
                type: 'GET',
                dataSrc: ''
            },
