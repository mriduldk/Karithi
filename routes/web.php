...
use App\Http\Controllers\KharithiController;
...
Route::get('udalguri', [KnowYourSchoolController::class, 'udalguri'])->name('udalguri');
Route::get('baksa', [KnowYourSchoolController::class, 'baksa'])->name('baksa');
Route::get('tamulpur', [KnowYourSchoolController::class, 'tamulpur'])->name('tamulpur');
Route::get('chirang', [KnowYourSchoolController::class, 'chirang'])->name('chirang');
Route::get('kokrajhar', [KnowYourSchoolController::class, 'kokrajhar'])->name('kokrajhar');

Route::get('lowerPrimarySchool', [KnowYourSchoolController::class, 'lowerPrimarySchool'])->name('lowerPrimarySchool');
Route::get('primarySchool', [KnowYourSchoolController::class, 'primarySchool'])->name('primarySchool');
Route::get('upperPrimarySchool', [KnowYourSchoolController::class, 'upperPrimarySchool'])->name('upperPrimarySchool');
Route::get('higherSecondarySchool', [KnowYourSchoolController::class, 'higherSecondarySchool'])->name('higherSecondarySchool');
